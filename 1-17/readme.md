...
[9.js如何做事件绑定及jsbin例子](./9.JS事件绑定及例子)

[10.什么是事件冒泡，什么是事件capture，及jsbin例子](./10.事件冒泡及事件捕获)

[11.怎么往函数内传另一个函数，及例子](./11.事件冒泡及事件捕获)

[12.console.log怎么用的，及例子](./12.js_console.log)

[13.debugger是什么及作用](./13.js_debugger)

[14.iife是什么，有什么作用及例子](./14.js_iife)

[15.new 的作用及例子](./15.js_new)

[16.js字符串处理有哪些方法及例子](./16.js_字符串常用操作方法)

[17.js数组操作有哪些方法及例子](./17.js_数组常用操作方法)
